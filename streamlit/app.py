...
with st.sidebar:
    ...
    AGENT_ID = st.text_input("Agent ID", os.getenv("AGENT_ID", "YOUR_AGENT_ID"))
    AGENT_ALIAS_ID = st.text_input("Agent Alias ID", os.getenv("AGENT_ALIAS_ID", "YOUR_AGENT_ALIAS_ID"))
